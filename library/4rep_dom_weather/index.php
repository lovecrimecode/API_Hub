...
<div class="form-container">
     <form method="post" action="result4.php" target="result" id="weatherForm">
          <div class="field">
               <label class="label is-size-5">
                    <i class="fas fa-city mr-2"></i>
                    Ingresa una ciudad de la República Dominicana
               </label>
               <div class="control has-icons-left">
                    <input class="input is-large custom-input"
                         type="text"
                         name="city"
                         placeholder="Escribe la ciudad aquí..."
                         required>
               </div>
          </div>
...
<div class="feature-card">
     ...
     <p class="is-size-7">
          Utilizamos una API de clima para obtener datos meteorológicos en tiempo real de ciudades en la República Dominicana.
     </p>
</div>
...
<div class="result-container">
     <div class="loading-overlay" id="loadingOverlay">
          <div class="has-text-centered">
               ...
               <p class="mt-3 has-text-weight-semibold">Obteniendo datos del clima...</p>
          </div>
     </div>
...
<div class="notification is-info is-light">
     ...
     <div class="columns">
          <div class="column">
               <p><strong>Actualización:</strong> Datos en tiempo real</p>
          </div>
          <div class="column">
               <p><strong>Cobertura:</strong> Ciudades de la República Dominicana</p>
          </div>
          <div class="column">
               <p><strong>Detalles:</strong> Incluye temperatura, humedad y más</p>
          </div>
     </div>
</div>
