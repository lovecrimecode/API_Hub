...
<div class="notification is-info is-light">
     ...
     <div class="columns">
          <div class="column">
               <p><strong>Precisión:</strong> Basado en datos demográficos reales</p>
          </div>
          <div class="column">
               <p><strong>Base de datos:</strong> Millones de registros</p>
          </div>
          <div class="column">
               <p><strong>Cobertura:</strong> Nombres de múltiples países</p>
          </div>
     </div>
</div>
